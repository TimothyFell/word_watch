...
function append_top_word(top_word) {
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.top-word > h3').append(`${Object.keys(top_word.word)}`);
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.word-count').append(`<h3>${Object.values(top_word.word)}</h3>`);
}
...
function parse_words() {
  var new_words = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#word").val().split(" ");
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(() => {
  get_top_word();
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#btn').on('click', function(e) {
    e.preventDefault();
    addNewWord();
  });
})
